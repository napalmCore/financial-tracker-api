...
{
    public class GetTransactionGroupedByCategoryValidator : FluentValidation.AbstractValidator<GetTransactionsGroupedByCategoryQuery>
    {
        public GetTransactionGroupedByCategoryValidator()
        {
